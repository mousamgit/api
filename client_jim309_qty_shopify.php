...
<?php
  ...
  echo "<h2>JIM309: Melbourne Jewellers Shopify Inventory QTY CSV Exported!</h2><br>";
  echo "Total Products Exported to CSV: ".$count."<br><br>";
  echo "<a style='font-weight:bold;' href='https://pim.samsgroup.info/client_export/jim309_inventory_import.csv'>View on Web</a><br><br>";
