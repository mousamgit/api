...
<?php
  ...
  $query = 'SELECT * FROM pim WHERE (brand = "Sapphire Dreams" AND type NOT LIKE "%loose%");';
  $result = mysqli_query($con, $query) or die(mysqli_error($con));

  $filepath = $_SERVER['DOCUMENT_ROOT'] . '/production/sd-id.csv';
  $fp = fopen($filepath, 'w');
  ...
  while($row = mysqli_fetch_assoc($result)){
    ...
    $content = array (
        ...
        1 => $row['edl9'],
        2 => $specification,
        3 => "ALL SAPPHIRE DREAMS SAPPHIRES ARE NATURAL, ETHICALLY SOURCED AND OF AUSTRALIAN ORIGIN.\nANY IMAGE PROVIDED IS INDICATIVE OF STYLE ONLY.",    
      );
...
echo "<center><h2>SD Jewellery ID CARD updated!</h2><br>";
echo "Total of ".$count." Products Exported<br><br>";
echo "<a href='https://pim.samsgroup.info/production/sd-id.csv'><b>View on Web</a><br><br>";
