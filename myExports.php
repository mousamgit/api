...
$scriptsToRun = [
    ...
    'Production - ID CARD PK' => ['script' =>'http://pim.samsgroup.info/export_pk_id.php', 'file' => 'https://samsgroup.info/production/pk-id.csv'],
    'Production - ID CARD BP' => ['script' =>'http://pim.samsgroup.info/export_bp_id.php', 'file' => 'https://samsgroup.info/production/bp-id.csv'],
    'Production - ID CARD SD' => ['script' =>'http://pim.samsgroup.info/export_sd_id.php', 'file' => 'https://samsgroup.info/production/sd-id.csv'],
