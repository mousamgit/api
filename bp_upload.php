...
$sql = " INSERT into pim (sku,product_title,brand,specifications,type,colour,clarity,carat,measurement,purchase_cost_aud,purchase_cost_usd,manufacturing_cost_aud,wholesale_aud,wholesale_usd,retail_aud,retail_usd,master_qty,warehouse_qty,mdqty,psqty,usdqty,image1,image2,image3,image4, shopify_qty)
     VALUES ('".$sku."','".$productTitle."','".$brand."','".$specifications."','".$type."','".$colour."','".$clarity."','".$carat."','".$measurement."','".$purchasecostAUD."','".$purchasecostUSD."','".$manufacturingcostAUD."','".$wholesaleAUD."','".$wholesaleUSD."','".$retailAUD."','".$retailUSD."','".$masterqty."','".$warehouseqty."','".$mdqty."','".$psqty."','".$usdqty."','".$image1."','".$image2."','".$image3."','".$image4."','".$shopifyqty."')
     ON DUPLICATE KEY UPDATE
     sku='".$sku."',product_title='".$productTitle."',brand='".$brand."',specifications='".$specifications."',type='".$type."',colour='".$colour."',clarity='".$clarity."',carat='".$carat."',measurement='".$measurement."',purchase_cost_aud='".$purchasecostAUD."',purchase_cost_usd='".$purchasecostUSD."',manufacturing_cost_aud='".$manufacturingcostAUD."',wholesale_aud='".$wholesaleAUD."',wholesale_usd='".$wholesaleUSD."',retail_aud='".$retailAUD."',retail_usd='".$retailUSD."',master_qty='".$mastermasterqty."',warehouse_qty='".$warehouseqty."',mdqty='".$mdqty."',psqty='".$psqty."',usdqty='".$usdqty."',image1='".$image1."',image2='".$image2."',image3='".$image3."',image4='".$image4."',shopify_qty='".$shopifyqty."'";
