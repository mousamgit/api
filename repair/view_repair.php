...
<html>
    ...
    <div class="pim-padding">
        ...
        <div style="float:left; width:50%;"><a href="./"><i class="fa-solid fa-left-long"></i> View All Repairs</a></div>
        ...
        <br>
            ...
            <div class="wrapper-box">
                ...
                <div class="form-row">
                    <div class="cell-l">System ID:</div> 
                    <div class="cell-r"><?php echo $row[id]; ?></div>
                </div>
                <div class="form-row">
