export default {
        props: ['channelAttribute','productDetailValue','selectedValues','showAttributeFirst'],
        data() {
            return {
                showAttribute: 0,
                columns: [],
                                            ...
                                            <div>
                                                ...
                                                <select class="form-control" v-model="cAttribute.attribute" @change="handleChangeAttribute(index)" required="">
                                                    <template v-for="column in columns">
                                                        <template v-if="column.column_name == productDetailValue.attribute_name">
                                                    ...
                                                    <div class="mb-3">
                                                        <template v-if="cAttribute.data_type == 'varchar'">
                                                            <select v-model="cAttribute.filter_type" id="filter-type" class="form-control">
                                                                <option value="includes" :selected="productDetailValue.filter_type === 'includes'">includes</option>
                                                                <option value="dont_includes" :selected="productDetailValue.filter_type === 'dont_includes'">doesn't include</option>
                                                                <option value="=" :selected="productDetailValue.filter_type === '='">equal to</option>
                                                                <option value="!=" :selected="productDetailValue.filter_type === '!='">not equal to</option>
                                                                <option value="IS NOT NULL" :selected="productDetailValue.filter_type === 'IS NOT NULL'">is not empty</option>
                                                                <option value="IS NULL" :selected="productDetailValue.filter_type === 'IS NULL'">is empty</option>
                                                            </select>
